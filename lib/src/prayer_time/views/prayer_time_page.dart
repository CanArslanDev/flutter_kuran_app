...
import 'package:quran_app/src/prayer_time/formatters/prayer_formatter.dart';
...
class PrayerTimePage extends StatelessWidget {
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Obx(() {
                        ...
                        List prayerNames = [
                          PrayerFormatter.format(Prayer.fajr.name.capitalize!),
                          PrayerFormatter.format(
                              Prayer.sunrise.name.capitalize!),
                          PrayerFormatter.format(Prayer.dhuhr.name.capitalize!),
                          PrayerFormatter.format(Prayer.asr.name.capitalize!),
                          PrayerFormatter.format(
                              Prayer.maghrib.name.capitalize!),
                          PrayerFormatter.format(Prayer.isha.name.capitalize!),
                        ];
  ...
  void activeScheduleNotification(
    ...
    if (hour != null || minute != null) {
      List prayerNames = [
        PrayerFormatter.format(Prayer.fajr.name.capitalize!),
        PrayerFormatter.format(Prayer.sunrise.name.capitalize!),
        PrayerFormatter.format(Prayer.dhuhr.name.capitalize!),
        PrayerFormatter.format(Prayer.asr.name.capitalize!),
        PrayerFormatter.format(Prayer.maghrib.name.capitalize!),
        PrayerFormatter.format(Prayer.isha.name.capitalize!),
      ];
      ...
      } else if (prayerName == prayerNames[0]) {
        // Change notif icon
        prayerTimeNotifC.enableSunrise.value =
            !prayerTimeNotifC.enableSunrise.value;
      ...
      } else if (prayerName == prayerNames[1]) {
        // Change notif icon
        prayerTimeNotifC.enableDhuhr.value =
            !prayerTimeNotifC.enableDhuhr.value;
      ...
      } else if (prayerName == prayerNames[2]) {
        // Change notif icon
      ...
      } else if (prayerName == prayerNames[3]) {
        // Change notif icon
        prayerTimeNotifC.enableMaghrib.value =
            !prayerTimeNotifC.enableMaghrib.value;
      ...
      } else if (prayerName == prayerNames[4]) {
        // Change notif icon
      ...
      } else if (prayerName == prayerNames[5]) {
        // Change notif icon
      ...
      Get.back();
      Get.snackbar("birdakika".tr(), "bildirimhatirlatici".tr());
    }
  }
