  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Obx(() {
        ...
        var timeNextDay = prayerTimeC.prayerTimesNextDay;
        ...
        switch (prayer) {
          ...
          case Prayer.sunrise:
            ...
            break;
          case Prayer.none:
            nextH = timeNextDay.value.shubuh?.hour;
            nextM = timeNextDay.value.shubuh?.minute;
            if (timeNextDay.value.shubuh != null) {
              leftOver = timeNextDay.value.shubuh!
                  .difference(DateTime.now())
                  .inSeconds;
              duration = time.value.isya!
                  .difference(timeNextDay.value.shubuh!)
                  .inSeconds;
            }
            break;
          default:
        ...
        log("Duration: $duration $prayer"); //25560
        log("LeftOver Value: ${prayerTimeC.leftOver.value}");
        log("InitDuration: $initDuration"); // 3962
                    ...
                    () => Text.rich(
                      TextSpan(
                        text: (nextH != null &&
                            ...
                            ? "sabah".tr()
                            : PrayerFormatter.format(prayerTimeC
