...
class SurahPage extends StatelessWidget {
                          ...
                          FadeInDown(
                            child: InkWell(
                              ...
                              child: SurahItem(
                                ...
                                name: controller.listOfSurah.toList()[i].name!,
                                numberOfVerses: controller.listOfSurah
                                    .toList()[i]
                                    .numberOfVerses,
                                nameOriginal: controller.listOfSurah
                                    .toList()[i]
                                    .nameOriginal,
                              ),
                            ),
  ...
  interstitalAdCheck() async {
    if (box.hasData("interstitialAdSurah")) {
      if (box.read("interstitialAdSurah") == 6) {
        AdsHelper().loadInterstitialAd();
        await box.write("interstitialAdSurah", 1);
      } else {
        var count = box.read("interstitialAdSurah");
        await box.write("interstitialAdSurah", count + 1);
      }
    } else {
      await box.write("interstitialAdSurah", 1);
    }
